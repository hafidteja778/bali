...
include "crew.php";
echo color("blue"," ∆ ∆ ∆ ∆ ∆ ∆ ∆ ∆ ∆ ∆ ∆ \n");
echo color("red","| MAIN OJOK MAGAK |\n");
echo color("green","| A U T O  C L A I M |\n");
echo color("green","| Group    : G.A.S N REM |\n");
echo color("green","| Fanspage : G N R|\n");
echo color("green","| Creator  : Anonymous.com          |\n");
echo "| Version : 2020      |\n";
...
// function change(){
        ...
        echo "\n".color("green","+] Message: ".$messageboba19);
        goride:
        echo "\n".color("yellow","!] Claim voc COBAGORIDESBY");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        echo "\n".color("yellow","!] Claim voc COBAGOCAR12");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
